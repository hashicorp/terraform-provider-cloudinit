...
If you wish to work on the provider, you'll first need [Go](http://www.golang.org) installed on your machine (version 1.18+ is *required*). You'll also need to set up a [GOPATH](http://golang.org/doc/code.html#GOPATH) correctly, as well as adding `$GOPATH/bin` to your `$PATH`.
